...
angular.module('myApp.controllers', []).
  controller('HomeControle', ['$scope', '$http', '$templateCache', 'FotoREST', function($scope, $http, $templateCache, FotoREST) {  
      ...
      post1.description = "RESTAURANTE : TRABALHAMOS COM SELF-SERVICE POR QUILO SEGUNDA À SÁBADO, DAS 10:30 AS15:00, CHURRASCO DE QUINTA E SEXTA, VARIAS OPÇÕES QUENTES E VARIEDADESEM SALADAS.";
      ...
      post2.title = "Buffet";
      post2.description = "BUFFET: TRABALHAMOS NO NOSSO SALÃO PARA ATÉ 120 PESSOAS OU À DOMICILIO. CASAMENTOS, NOIVADOS, CONFRATERNIZAÇÕES, ANIVERSÁRIOS INFANTIS, JANTARES, ÓTIMOS PREÇOS FAÇA ORÇAMENTO SEM COMPROMISSO SANDRA.ARABE@IG.COM.BR TEL 4104-3888 NEXTEL 7914-4601 ID 927*24605";      $scope.posts.push(post2);
      ...
      post3.description = "RESTAURANTE : TRABALHAMOS COM SELF-SERVICE POR QUILO SEGUNDA À SÁBADO, DAS 10:30 AS15:00, CHURRASCO DE QUINTA E SEXTA, VARIAS OPÇÕES QUENTES E VARIEDADESEM SALADAS.";

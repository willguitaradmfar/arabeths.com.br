...
angular.module('myApp.controllers', []).
  controller('HomeControle', ['$scope', '$http', '$templateCache', 'FotoREST', function($scope, $http, $templateCache, FotoREST) {  
      ...
      post2.title = "Buffet";
      post2.description = "TRABALHAMOS NO NOSSO SALÃO PARA ATÉ 120 PESSOAS OU À DOMICILIO. CASAMENTOS, NOIVADOS, CONFRATERNIZAÇÕES, ANIVERSÁRIOS INFANTIS, JANTARES, ÓTIMOS PREÇOS FAÇA ORÇAMENTO SEM COMPROMISSO SANDRA.ARABE@IG.COM.BR TEL 4104-3888 NEXTEL 7914-4601 ID 927*24605";      $scope.posts.push(post2);
      ...
      post3.description = "Comida Caseira. Entregamos ? Domicilio. Fa?a j? o seu pedido.";
      $scope.posts.push(post3);


     $scope.frase = "?TIMOS PRE?OS FA?A OR?AMENTO SEM COMPROMISSOSANDRA.ARABE@IG.COM.BR TEL 4104-3888 NEXTEL 7914-4601 ID 927*24605";
